...
/**
 * API endpoint to update the status of an assignment archiving task
 */
class update_task_status extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'taskid' => new external_value(
                PARAM_INT,
                'ID of the assignment archiving task this request belongs to',
                VALUE_REQUIRED
            ),
            'status' => new external_value(
                PARAM_INT,
                'New status to set for the given assignment archiving task',
                VALUE_REQUIRED
            ),
     ...
     * @param int $taskidraw ID of the assignment archiving task this request belongs to
     * @param int $statusraw New status to set for the given assignment archiving task,
     *                       based on \local_archiving\type\assignment_archiving_task_status
