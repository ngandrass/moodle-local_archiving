...
A complete list of all valid archive job states is defined in {{ source_file('classes/local/type/archive_job_status.php', 
'\\local_archiving\\local\\type\\archive_job_status') }}.
