...
$string['setting_path_style'] = 'Use path-style access';
$string['setting_path_style_desc'] = 'If enabled, the bucket name is included in the request path (<code>https://endpoint/bucket/key</code>) instead of the hostname (<code>https://bucket.endpoint/key</code>). Self-hosted S3-compatible services such as MinIO or Ceph often require path-style access.';
