...
$string['task_attachment_type_annotation'] = 'Annotated PDF files';
$string['task_attachment_type_annotation_help'] = 'Include PDF files that were annotated by the grader. This does not include additional files that were uploaded by the grader.';
$string['task_attachment_type_assignment'] = 'Intro files';
$string['task_attachment_type_assignment_help'] = 'Include files attached to the assignment introduction. These are files that are given alongside the assignment instructions and were provided by the assignment creator.';
$string['task_attachment_type_feedback'] = 'Feedback files';
$string['task_attachment_type_feedback_help'] = 'Include feedback files uploaded by the grader. This does not include PDFs that were annotated by the grader within Moodle.';
$string['task_attachment_type_submission'] = 'Submission files';
$string['task_attachment_type_submission_help'] = 'Include files submitted by the student during the submission.';
$string['task_export_submissions_metadata'] = 'Export submissions metadata';
$string['task_export_submissions_metadata_help'] = 'A tabular file containing the metadata of all archived submissions will be created inside the assignment archive.';
