...
$string['archiving_manager'] = 'Archiving manager';
...
$string['can_not_create_archive_manual_archiving_disabled'] = 'Manually triggering the creation of new archives has been disabled by your system administrator. You can still access previously created archives using the table below. New archives can be created automatically if configured accordingly.';
...
$string['deleted_file_can_not_be_retrieved'] = 'This file was deleted and can no longer be retrieved.';
...
$string['error_retrieval_cancelled'] = 'Retrieval was cancelled.';
$string['fetch_remote_file_prompt'] = 'This file is stored on remote storage and must be fetched before it can be downloaded. This may take a while.';
$string['fetch_retry'] = 'Retry';
$string['fetch_status_queued'] = 'Waiting to be processed. This page will refresh automatically.';
$string['fetch_status_stale'] = 'The previous fetch attempt appears to be stuck or has stopped responding.';
$string['fetch_to_download'] = 'Fetch to download';
...
$string['retrieving_from_remote_storage'] = 'Retrieving from remote storage ...';
...
$string['setting_coursecat_whitelist'] = 'Course categories';
$string['setting_coursecat_whitelist_desc'] = 'Select all course categories in which archiving should be allowed. If a category is selected here, archiving is enabled for all courses that are part of the category or any of its subcategories. To enable archiving globally, select the top-level category.';
...
$string['setting_max_concurrent_jobs'] = 'Parallel jobs';
$string['setting_max_concurrent_jobs_desc'] = 'The maximum number of archive jobs that can be executed concurrently. If more jobs are queued, they will wait until a running job has finished. This setting can be used to limit the system load.';
...
$string['manage_components_archiving_manager_desc'] = 'The archiving manager is the core component of the archiving system. It is responsible for coordinating the different sub-plugins and managing the overall archiving process.';
$string['error_localpath_could_not_be_created'] = 'The directory does not exist and could not be created, or it is not writable. Please make sure that the directory exists and is writable by the web server user.';
...
$string['error_localpath_overlaps_dataroot'] = 'The directory must not be the Moodle data directory ($CFG->dataroot) or one of its parent directories.';
$string['error_localpath_overlaps_dirroot'] = 'The directory must not be located inside, or contain, the Moodle code directory ($CFG->dirroot).';
$string['error_at_least_one_coursecat_required'] = 'At least one course category must be selected.';
$string['warning_no_activity_archiving_driver_enabled'] = '<b>Warning:</b> No activity archiving driver is currently enabled. This means that no activities can ever be archived. Please enable at least one activity archiving driver in the table below.';
$string['warning_no_storage_driver_enabled'] = '<b>Warning:</b> No storage driver is currently enabled. Therefore, no new archives can ever be stored. Please enable at least one storage driver in the table below to be able to create new archive jobs.';
$string['warning_no_archiving_triggers_enabled'] = '<b>Warning:</b> No archiving trigger is currently enabled. Therefore, no new archive jobs can ever be created. Please enable at least one archiving trigger in the table below to be able to create new archive jobs.';
