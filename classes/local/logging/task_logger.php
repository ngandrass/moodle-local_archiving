...
namespace local_archiving\local\logging;
...
class task_logger extends job_logger {
    ...
    public function log(log_level $level, string $message): void {
        $this->write_log_entry_to_db($level, $message, $this->jobid, $this->taskid);
    }
    ...
    public function trace(string $message): void {
        $this->write_log_entry_to_db(log_level::TRACE, $message, $this->jobid, $this->taskid);
    }
    ...
    public function debug(string $message): void {
        $this->write_log_entry_to_db(log_level::DEBUG, $message, $this->jobid, $this->taskid);
    }
    ...
    public function info(string $message): void {
        $this->write_log_entry_to_db(log_level::INFO, $message, $this->jobid, $this->taskid);
    }
    ...
    public function error(string $message): void {
        $this->write_log_entry_to_db(log_level::ERROR, $message, $this->jobid, $this->taskid);
    }
