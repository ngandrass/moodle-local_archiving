...
$string['setting_header_docs_desc'] = 'This plugin archives quiz attempts as PDF and HTML files. It <b>requires a separate <a href="https://archiving.gandrass.de/archivingmod/quiz/worker/" target="_blank">worker service</a></b> to be installed for the actual archiving process to work. Please refer to the <a href="https://archiving.gandrass.de/archivingmod/quiz/" target="_blank">documentation</a> for more details and setup instructions.';
...
$string['task_report_section_question_correctness'] = 'Include question correctness';
$string['task_report_section_question_correctness_help'] = 'Shows whether a question was answered correctly or not inside the attempt report.';
...
$string['task_report_section_quiz_grade'] = 'Include quiz grade';
$string['task_report_section_quiz_grade_help'] = 'Displays the overall quiz grade inside the attempt report header.';
