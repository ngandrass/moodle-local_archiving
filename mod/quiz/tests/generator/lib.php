...
class archivingmod_quiz_generator extends \testing_data_generator {
    ...
    public const QUIZ_FIXTURES = [
        ...
        'multiattempt' => [
            'backupfile' => '/../fixtures/referencequiz-multiattempt.mbz',
            'quizname' => 'Reference Quiz (standard question types)',
        ],
        'qtype_jack' => [
    ...
    public function create_mock_quiz(bool $createquestion = false, bool $createattempt = false): \stdClass {
        ...
        return (object) [
            ...
            'settings' => [
                'num_attempts' => count($attemptmetadata),
                'export_attempts' => 1,
                'report_section_header' => 1,
                'report_section_quiz_feedback' => 1,
                'report_section_question' => 1,
                'report_section_question_feedback' => 0,
                'report_section_general_feedback' => 1,
                'report_section_rightanswer' => 0,
                'report_section_history' => 1,
                'report_section_attachments' => 1,
     ...
     */
    public function create_mock_task(?string $wstoken = null, bool $createattempt = true): \stdClass {
        global $DB;

        // Create mocks.
        $mocks = self::create_mock_quiz(createquestion: true, createattempt: $createattempt);
