...
/**
 * Tests for the archivingmod_quiz test data generator
 *
...
final class generator_test extends \advanced_testcase {
     ...
     *
     * @covers \archivingmod_quiz_generator::create_mock_quiz
     *
     * @return void
     ...
     * filearea
     *
     * @covers \archivingmod_quiz_generator::import_reference_quiz_artifact_as_draft
     *
     ...
     *
     * @covers \archivingmod_quiz_generator::create_temp_file
     *
     * @return void
     * @throws \file_exception
     * @throws \stored_file_creation_exception
    ...
    public function test_create_temp_file(): void {
        ...
        $this->assertEquals('archivingmod_quiz', $tempfile->get_component(), 'The temp file has the wrong component');
        $this->assertEquals(filearea::TEMP->value, $tempfile->get_filearea(), 'The temp file has the wrong filearea');
